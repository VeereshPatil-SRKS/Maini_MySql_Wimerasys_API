...
namespace IFacilityMaini
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // var connection = @"Server=localhost;Database=unitworksccs;user id=root;password=1068;";
         var connection = @"Server=localhost;Database=unitworksccs;user id=root;password=srks4$maini;";
            ...
            services.AddDbContext<unitworksccsContext>(options => options.UseMySQL(connection));
            ...
            services.AddTransient<IMainiAPI, MainiAPIDAL>();

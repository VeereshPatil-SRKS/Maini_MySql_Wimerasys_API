...
{
    public partial class UnitworkccsTblrolemodulelink
    {
        ...
        public virtual UnitworkccsTblusers InsertedByNavigation { get; set; }
        public virtual UnitworkccsTblmodules Module { get; set; }
        public virtual UnitworkccsTblroles ModuleNavigation { get; set; }
    }
}

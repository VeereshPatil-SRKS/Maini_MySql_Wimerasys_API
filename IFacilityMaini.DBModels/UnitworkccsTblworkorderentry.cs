...
{
    public partial class UnitworkccsTblworkorderentry
    {
        public UnitworkccsTblworkorderentry()
        {
            UnitworkccsTblProdandondisp = new HashSet<UnitworkccsTblProdandondisp>();
        ...
        public virtual ICollection<UnitworkccsTblProdandondisp> UnitworkccsTblProdandondisp { get; set; }

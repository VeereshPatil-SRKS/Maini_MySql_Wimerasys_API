...
{
    public partial class UnitworkccsConfigurationtblsensormaster
    {
        ...
        public virtual UnitworkccsConfigurationTblsensorgroup S { get; set; }
        public virtual UnitworkccsTblunit Unit { get; set; }
    }
}

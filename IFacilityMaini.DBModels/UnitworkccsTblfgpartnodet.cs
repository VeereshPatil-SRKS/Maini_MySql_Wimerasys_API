...
{
    public partial class UnitworkccsTblfgpartnodet
    {
        public UnitworkccsTblfgpartnodet()
        {
            UnitworkccsTblProdmanmachine = new HashSet<UnitworkccsTblProdmanmachine>();
        }
        ...
        public virtual ICollection<UnitworkccsTblProdmanmachine> UnitworkccsTblProdmanmachine { get; set; }
    }
}

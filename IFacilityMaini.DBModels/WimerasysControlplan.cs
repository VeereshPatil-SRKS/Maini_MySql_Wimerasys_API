...
{
    public partial class WimerasysControlplan
    {
        public WimerasysControlplan()
        {
            WimerasysCpdetails = new HashSet<WimerasysCpdetails>();
        }
        ...
        public virtual ICollection<WimerasysCpdetails> WimerasysCpdetails { get; set; }
    }
}
